...
pub fn build(b: *std.Build) void {
    ...
    // in this directory.
    //
    // Note: To enable sanitizers, use compiler flags:
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "gshell" is the name you will use in your source code to
                // import this module (e.g. `@import("gshell")`). The name is
